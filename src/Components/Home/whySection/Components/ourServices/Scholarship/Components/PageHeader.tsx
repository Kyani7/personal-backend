...
export default function PageHeader({
  ...
  description = "Maximize your funding opportunities with expert guidance for scholarships across Australia, UK, Canada, USA, New Zealand, Japan, Sweden, and Germany.",
