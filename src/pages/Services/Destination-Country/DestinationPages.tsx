      ...
      <section className="z-50 min-h-200 bg-white">
        <div className="sticky top-0 z-50 bg-white">
          <MiniPannel
            ...
            body={
              "We provide personalized counselling services for students aspiring to study abroad across multiple countries, helping them choose the best pathway for their academic and career goals."
            }
          />
