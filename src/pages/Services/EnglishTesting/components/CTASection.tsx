...
export default function CTASection({
  ...
  return (
    <section className="bg-gradient-to-b from-[#eaf3fb] to-[#f7fafd] px-6 py-20 text-center sm:px-10 md:px-20">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-16 gap-y-4">
        ...
        <a
          ...
          className={buttonBase + " border-2 border-gray-200 bg-white text-brand-blue hover:border-brand-blue hover:bg-blue-50"}
        >
          Email Us:
        </a>
        <button
