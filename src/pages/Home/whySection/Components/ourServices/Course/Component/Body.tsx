...
export default function Body({
  heading = "About Courses on Demand",
  description = `Hima Aus' course selection service, refined over 16+ years, scans 15,000+ programs in Australia, UK, Canada, USA, New Zealand, Japan, Sweden, and Germany to deliver perfect fits—balancing academics, costs, and career outcomes for thousands of successful placements. We incorporate emerging trends like AI ethics, sustainable business, and digital health to future-proof your education. Our team provides side-by-side comparisons, including alumni success stories and ROI calculations, to empower confident choices.`,
