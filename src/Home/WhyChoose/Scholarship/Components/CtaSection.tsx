    ...
    <section className="bg-gradient-to-b from-blue-50 to-white px-4 py-16 text-center sm:px-8">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
        ...
        <button
          type="button"
          onClick={onBookClick}
          className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-blue-700"
        >
